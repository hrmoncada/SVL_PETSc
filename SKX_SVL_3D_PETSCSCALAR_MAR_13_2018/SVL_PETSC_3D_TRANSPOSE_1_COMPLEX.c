...
# undef __FUNCT__
# define __FUNCT__ "SVL_3D_TRANSPOSE_1_COMPLEX"
PetscErrorCode SVL_3D_TRANSPOSE_1_COMPLEX(PetscInt Nx, PetscInt Ny, PetscInt Nz, PetscScalar* U) {
  PetscInt i, j, k;  
