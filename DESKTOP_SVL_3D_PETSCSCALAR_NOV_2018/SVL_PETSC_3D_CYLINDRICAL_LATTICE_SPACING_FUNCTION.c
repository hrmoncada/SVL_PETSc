...
# undef __FUNCT__
# define __FUNCT__ "SVL_3D_CYLINDRICAL_LATTICE_SPACING_FUNCTION"
PetscErrorCode SVL_3D_CYLINDRICAL_LATTICE_SPACING_FUNCTION(PetscInt New_Nx, PetscInt New_Ny, PetscInt New_Nz,  PetscReal* RSQ, PetscReal* PER) {
  PetscInt  i, j, k;
  PetscReal a = 1.0;
  PetscErrorCode ierr;
